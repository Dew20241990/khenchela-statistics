...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        arabic: ['Noto Sans Arabic', 'Noto Kufi Arabic', 'system-ui', 'sans-serif'],
        kufi: ['Noto Kufi Arabic', 'Noto Sans Arabic', 'system-ui', 'sans-serif'],
      },
      colors: {
        ...
        gov: {
          ...
          red: "hsl(var(--gov-red))",
          "blue-accent": "hsl(var(--gov-blue-accent))",
        },
        chart: {
          "1": "hsl(var(--chart-1))",
          "2": "hsl(var(--chart-2))",
